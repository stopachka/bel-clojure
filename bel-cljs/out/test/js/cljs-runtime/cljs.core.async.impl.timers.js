...
var i_14631 = (self__.level + (1));
while(true){
if((i_14631 <= (new_level + (1)))){
(update[i_14631] = self__.header);

var G__14634 = (i_14631 + (1));
i_14631 = G__14634;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14638 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14638[i]));
} else {
x__$2.forward.push((((i < links_14638.length))?(links_14638[i]):null));
}

if((i < links_14638.length)){
(links_14638[i] = x__$2);
} else {
links_14638.push(x__$2);
}
...
var i_14646 = (0);
while(true){
if((i_14646 <= self__.level)){
var links_14647 = (update[i_14646]).forward;
if((x__$1 === (((i_14646 < links_14647.length))?(links_14647[i_14646]):null))){
(links_14647[i_14646] = (x__$1.forward[i_14646]));

var G__14654 = (i_14646 + (1));
i_14646 = G__14654;
continue;
} else {
var G__14655 = (i_14646 + (1));
i_14646 = G__14655;
continue;
}
} else {
...
var G__14662 = nx;
var G__14663 = (level__$1 - (1));
x = G__14662;
level__$1 = G__14663;
continue;
} else {
var G__14664 = x;
var G__14665 = (level__$1 - (1));
x = G__14664;
level__$1 = G__14665;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__14674 = nx;
var G__14675 = (level__$1 - (1));
x = G__14674;
level__$1 = G__14675;
continue;
} else {
var G__14677 = x;
var G__14678 = (level__$1 - (1));
x = G__14677;
level__$1 = G__14678;
continue;
}

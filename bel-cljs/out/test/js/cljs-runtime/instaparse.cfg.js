...
var G__24411 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__24411)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__24411)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__24411)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24411)].join('')));
...
var G__24577 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__24578 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__24577;
v = G__24578;
continue;
} else {
var G__24579 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__24580 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__24579;
v = G__24580;
continue;
}
...
break;
case "\"":
var G__24581 = cljs.core.next(sq);
var G__24582 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__24581;
v = G__24582;
continue;
...
break;
default:
var G__24583 = cljs.core.next(sq);
var G__24584 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__24583;
v = G__24584;
continue;
...
while(true){
var G__24484 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__24484__$1 = (((G__24484 instanceof cljs.core.Keyword))?G__24484.fqn:null);
switch (G__24484__$1) {
case "rule":
var vec__24485 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24485,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24485,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__24489 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__24489) : instaparse.cfg.content.call(null,G__24489));
...
break;
case "paren":
var G__24592 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__24592;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__24491 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__24491) : instaparse.cfg.build_rule.call(null,G__24491));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__24492 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__24492) : instaparse.cfg.build_rule.call(null,G__24492));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__24493 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__24493) : instaparse.cfg.build_rule.call(null,G__24493));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__24494 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__24494) : instaparse.cfg.build_rule.call(null,G__24494));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__24500 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__24500) : instaparse.cfg.build_rule.call(null,G__24500));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__24504 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__24504) : instaparse.cfg.build_rule.call(null,G__24504));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24484__$1)].join('')));
...
while(true){
var G__24508 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__24613 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__24613;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24508__$1)].join('')));
...
var valid_nts_24616 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__24513_24617 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__24514_24618 = null;
var count__24515_24619 = (0);
var i__24516_24620 = (0);
while(true){
if((i__24516_24620 < count__24515_24619)){
var nt_24621 = chunk__24514_24618.cljs$core$IIndexed$_nth$arity$2(null,i__24516_24620);
if(cljs.core.truth_((valid_nts_24616.cljs$core$IFn$_invoke$arity$1 ? valid_nts_24616.cljs$core$IFn$_invoke$arity$1(nt_24621) : valid_nts_24616.call(null,nt_24621)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_24621),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__24622 = seq__24513_24617;
var G__24623 = chunk__24514_24618;
var G__24624 = count__24515_24619;
var G__24625 = (i__24516_24620 + (1));
seq__24513_24617 = G__24622;
chunk__24514_24618 = G__24623;
count__24515_24619 = G__24624;
i__24516_24620 = G__24625;
continue;
} else {
var temp__5804__auto___24626 = cljs.core.seq(seq__24513_24617);
if(temp__5804__auto___24626){
var seq__24513_24627__$1 = temp__5804__auto___24626;
if(cljs.core.chunked_seq_QMARK_(seq__24513_24627__$1)){
var c__5568__auto___24629 = cljs.core.chunk_first(seq__24513_24627__$1);
var G__24630 = cljs.core.chunk_rest(seq__24513_24627__$1);
var G__24631 = c__5568__auto___24629;
var G__24632 = cljs.core.count(c__5568__auto___24629);
var G__24633 = (0);
seq__24513_24617 = G__24630;
chunk__24514_24618 = G__24631;
count__24515_24619 = G__24632;
i__24516_24620 = G__24633;
continue;
} else {
var nt_24636 = cljs.core.first(seq__24513_24627__$1);
if(cljs.core.truth_((valid_nts_24616.cljs$core$IFn$_invoke$arity$1 ? valid_nts_24616.cljs$core$IFn$_invoke$arity$1(nt_24636) : valid_nts_24616.call(null,nt_24636)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_24636),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__24637 = cljs.core.next(seq__24513_24627__$1);
var G__24638 = null;
var G__24639 = (0);
var G__24640 = (0);
seq__24513_24617 = G__24637;
chunk__24514_24618 = G__24638;
count__24515_24619 = G__24639;
i__24516_24620 = G__24640;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__24523_24645 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__24524_24646 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__24525_24647 = true;
var _STAR_print_fn_STAR__temp_val__24526_24648 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__24525_24647);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__24526_24648);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__24524_24646);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__24523_24645);
}
...
var G__24656 = (i__5770__auto___24652 + (1));
i__5770__auto___24652 = G__24656;
continue;
} else {
}
break;
...
return instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5776__auto__);
});

(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__24541){
var map__24542 = p__24541;
var map__24542__$1 = cljs.core.__destructure_map(map__24542);
var opts = map__24542__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__24543 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__24544 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__24544);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__5690__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__24546_24658 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__24547_24659 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__24548_24660 = true;
var _STAR_print_fn_STAR__temp_val__24549_24661 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__24548_24660);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__24549_24661);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__24547_24659);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__24546_24658);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__5690__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__24543);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq24535){
var G__24536 = cljs.core.first(seq24535);
var seq24535__$1 = cljs.core.next(seq24535);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24536,seq24535__$1);
}));

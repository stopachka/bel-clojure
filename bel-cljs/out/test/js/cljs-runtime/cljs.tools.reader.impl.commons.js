...
var G__12121 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__12121;
continue;
} else {
return ch;
...
var vec__12108 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12108,(0),null);
return (match === s);
});
...
var G__12148 = (i__5770__auto___12145 + (1));
i__5770__auto___12145 = G__12148;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq12116){
...
return (function() { 
var G__12149__delegate = function (rdr,_){
...
var G__12149 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__12150__i = 0, G__12150__a = new Array(arguments.length -  1);
while (G__12150__i < G__12150__a.length) {G__12150__a[G__12150__i] = arguments[G__12150__i + 1]; ++G__12150__i;}
  _ = new cljs.core.IndexedSeq(G__12150__a,0,null);
} 
return G__12149__delegate.call(this,rdr,_);};
G__12149.cljs$lang$maxFixedArity = 1;
G__12149.cljs$lang$applyTo = (function (arglist__12151){
var rdr = cljs.core.first(arglist__12151);
var _ = cljs.core.rest(arglist__12151);
return G__12149__delegate(rdr,_);
});

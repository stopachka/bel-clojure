...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_16324 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_16324(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_16329 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_16329(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_16340 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_16340(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_16349 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_16349(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_16356 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_16356(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_16361 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_16361(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__16312,callback){
var map__16314 = p__16312;
var map__16314__$1 = cljs.core.__destructure_map(map__16314);
var input = map__16314__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16314__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16314__$1,new cljs.core.Keyword(null,"ns","ns",441598760));

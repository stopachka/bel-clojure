...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11902 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11902(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11903 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11903(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11918 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11918(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11922 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11922(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11926 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11926(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11935 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11935(reader);
}
});
...
var G__12026 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__12027 = s.append(c);
c = G__12026;
s = G__12027;
continue;
}
